            ...
            <div className="prose prose-blue max-w-none text-gray-600">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mt-6">
                <p className="text-blue-800 font-medium">
                  ¿Necesitas calcular tus prestaciones con los nuevos valores?
                </p>
                <p className="text-blue-600 mt-2">
                  Utiliza nuestras calculadoras actualizadas para 2025:
                </p>
                <div className="mt-4 flex flex-wrap gap-4">
                  <Link href="/calculadoras/nomina" className="text-blue-600 hover:text-blue-800 underline">
                    Calculadora de Nómina
                  </Link>
                  <Link href="/calculadoras/liquidacion" className="text-blue-600 hover:text-blue-800 underline">
                    Calculadora de Liquidación
                  </Link>
                  <Link href="/calculadoras/prima" className="text-blue-600 hover:text-blue-800 underline">
